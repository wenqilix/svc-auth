...
class TokenServiceTests {
    ...
    @MockK
    lateinit var mockCorppass: Provider
    @MockK
    ...
    fun setupMock() {
        ...
        every { mockProperties.corppass } returns mockCorppass
        every { mockCorppass.additionalInfoRequest } returns mockAdditionalInfoRequest
